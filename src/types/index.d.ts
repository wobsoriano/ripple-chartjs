...
export declare function Doughnut(
	props: TypedChartProps<'doughnut', DefaultDataPoint<'doughnut'>>
): void;
export declare function PolarArea(
	props: TypedChartProps<'polarArea', DefaultDataPoint<'polarArea'>>
): void;
...
export declare function Scatter(
	props: TypedChartProps<'scatter', DefaultDataPoint<'scatter'>>
): void;
